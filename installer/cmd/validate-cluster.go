...
import (
	...
	"github.com/bhojpur/platform/installer/pkg/cluster"
...
func init() {
	...
	validateClusterCmd.PersistentFlags().StringVarP(&validateClusterOpts.Config, "config", "c", os.Getenv("BHOJPUR_INSTALLER_CONFIG"), "path to the config file")
}
