...
import (
	...
	"github.com/bhojpur/platform/ws-daemon/pkg/resources"
...
func (v version) Defaults(in interface{}) error {
	...
	cfg.Domain = "app.bhojpur.net"
	cfg.Repository = "ap.gcr.io/bhojpur/build"
	...
	cfg.Application.Runtime.FSShiftMethod = FSShiftFuseFS
	cfg.Application.Runtime.ContainerDSocket = "/run/containerd/containerd.sock"
	cfg.Application.Runtime.ContainerDRuntimeDir = "/var/lib/containerd/io.containerd.runtime.v2.task/k8s.io"
...
// Taken from github.com/bhojpur/platform/components/bhojpur-protocol/src/util/logging.ts
const (
...
type Application struct {
	Runtime   ApplicationRuntime    `json:"runtime" validate:"required"`
	Resources Resources             `json:"resources" validate:"required"`
	Templates *ApplicationTemplates `json:"templates,omitempty"`
}
