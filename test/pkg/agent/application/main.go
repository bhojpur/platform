...
import (
	...
	"github.com/bhojpur/platform/test/pkg/agent/application/api"
...
// ApplicationAgent provides ingteration test services from within a workspace
type ApplicationAgent struct {
}

// ListDir lists a directory's content
func (*ApplicationAgent) ListDir(req *api.ListDirRequest, resp *api.ListDirResponse) error {
...
// WriteFile writes a file in the application
func (*ApplicationAgent) WriteFile(req *api.WriteFileRequest, resp *api.WriteFileResponse) (err error) {
...
func (*ApplicationAgent) Exec(req *api.ExecRequest, resp *api.ExecResponse) (err error) {
