...
import (
	...
	imgapi "github.com/bhojpur/platform/image-builder/api"
				...
				Source: &imgapi.BuildSource{
					From: &imgapi.BuildSource_File{
						File: &imgapi.BuildSourceDockerfile{
							...
							DockerfilePath:    ".bhojpur.Dockerfile",
							ContextPath:       ".",
							Source: &csapi.ApplicationInitializer{
								Spec: &csapi.ApplicationInitializer_Git{
									Git: &csapi.GitInitializer{
										RemoteUri:  "https://github.com/bhojpur/ara.git",
